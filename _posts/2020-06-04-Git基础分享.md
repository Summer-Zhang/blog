...
*  feature(功能), release(预发布), hotfix(修补bug)辅助分支: 辅助开发分支，用于应对一些特定目的的版本开发.
	...
	```
*  
![git branching model](https://upload-images.jianshu.io/upload_images/1089501-f51a770d425f3881.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
